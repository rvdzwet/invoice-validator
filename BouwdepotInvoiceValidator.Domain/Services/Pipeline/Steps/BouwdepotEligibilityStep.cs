...
namespace BouwdepotInvoiceValidator.Domain.Services.Pipeline.Steps
{
    ...
    /// </summary>
    public class BouwdepotEligibilityStep : IValidationPipelineStep
    {
        private readonly ILogger<BouwdepotEligibilityStep> _logger;
        private readonly PromptService _promptService;
        
        /// <summary>
        /// Gets the name of the step
        /// </summary>
        public string StepName => "DetermineWithdrawalEligibility";
        
        /// <summary>
        /// Gets the order of the step in the pipeline
        /// </summary>
        public int Order => 500; // After fraud detection (400)
        
        /// <summary>
        /// Gets the prompt template name for this step
        /// </summary>
        public string PromptTemplatePath => "MultiModalHomeImprovement";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BouwdepotEligibilityStep"/> class
        /// </summary>
        /// <param name="logger">The logger</param>
        /// <param name="promptService">The prompt service</param>
        public BouwdepotEligibilityStep(
            ILogger<BouwdepotEligibilityStep> logger,
